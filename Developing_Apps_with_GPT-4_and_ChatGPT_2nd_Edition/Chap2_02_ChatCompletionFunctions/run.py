...
def find_product(sql_query):
    print("find_product was called with:", sql_query)
    # Execute query here
    results = [
...
def run(user_question):
	...
	# The book original uses gpt-3.5-turbo-0613
    response = client.chat.completions.create(model="gpt-5-nano", messages=messages, tools=[{"type": "function", "function": function_find_product }])
	...
	# The book original uses gpt-3.5-turbo-0613
    second_response = client.chat.completions.create(model="gpt-5-nano",
    messages=messages)
